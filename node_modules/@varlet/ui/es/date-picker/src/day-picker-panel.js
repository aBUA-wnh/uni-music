...
export default defineComponent({
  ...
  setup(props, {
    ...
    var sortWeekList = computed(() => {
      var index = WEEK_HEADER.findIndex(week => week.index === toNumber(props.componentProps.firstDayOfWeek));
      if (index === -1 || index === 0) return WEEK_HEADER;
      return WEEK_HEADER.slice(index).concat(WEEK_HEADER.slice(0, index));
    });

    var getDayAbbr = key => pack.value.weekDictionary[key].abbr;
