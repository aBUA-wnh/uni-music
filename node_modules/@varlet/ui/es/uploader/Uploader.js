...
export default defineComponent({
  ...
  setup(props) {
    ...
    var handleRemove = removedVarFile => {
      ...
      (_props$onUpdateModel2 = props['onUpdate:modelValue']) == null ? void 0 : _props$onUpdateModel2.call(props, modelValue.filter(varFile => varFile !== removedVarFile));
