...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"2021.10.08-uniapp","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var _find = _interopRequireDefault(__webpack_require__(/*! @/api/find.js */ 43));
var _songListDetail = _interopRequireDefault(__webpack_require__(/*! @/api/song-list-detail.js */ 44));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var serverUrl = 'https://pl-fe.cn/cloud-music-api';
  ...
  var promise = new Promise(function (resolve, reject) {
    ...
    function (res) {
      ...
      switch (res[1].statusCode) {
        ...
        case 504:
          uni.showToast({
            title: "\u670D\u52A1\u5668\u9519\u8BEF:".concat(res[1].data.message),
            icon: 'none',
            duration: 2000 });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = _default;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request.js */ 42));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
